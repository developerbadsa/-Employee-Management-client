  ...
  <div className="justify-center flex-1 max-w-5xl px-4 py-4 mx-auto lg:py-10 md:px-7">
    <div className="max-w-xl mx-auto">
      <div className="text-center ">
        <SectionIntro title={'Contact Us'} description={'Use the form below to send us a message. Whether you have inquiries about our platform, need technical support, or want to explore partnership opportunities, were eager to hear from you. Our team will respond promptly to ensure your experience with our employee management system is seamless.'}></SectionIntro>
      </div>
    </div>
