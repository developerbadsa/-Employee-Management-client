  ...
  return (
    <Carousel className="h-[90vh]">
      <div className="relative h-full w-full">
        ...
        />
        <div className="absolute inset-0 grid h-full w-full place-items-center bg-black/75 py-12">
      ...
      <div className="relative h-full w-full">
        <img
          ...
          className="h-full w-full object-cover"
        />
        <div className="absolute inset-0 grid h-full w-full items-center bg-black/75 py-12">
      ...
      <div className="relative h-full w-full">
        <img
          ...
          className="h-full w-full object-cover"
        />
        <div className="absolute inset-0 grid h-full w-full items-end bg-black/75 py-12">
